...
import { readRecSeed, writeRecSeed, readTimeOverride, writeTimeOverride, readWeatherOverride, setWeatherOverride, makeObjectStore, readSeasonalMode, writeSeasonalMode } from "../utils/userStorage";
...
export default function Dashboard({ answers, onResetOnboarding = () => {} }) {
  ...
  const generatedOutfits = useMemo(
    ...
    [wardrobe, recSeed, bodyTypeId, recentExactSigs, recentItemCounts, weatherCategory, timeCategory, effectiveAnswers, savedSigs, currentSeason, seasonalMode, feedbackProfile, personalizationProfile]
  );
  ...
  }, [outfits, weatherCategory, timeCategory, effectiveAnswers, bodyTypeId, aiSource, reused, pairedExplanations, currentSeason, seasonalMode, feedbackProfile, personalizationProfile]);
