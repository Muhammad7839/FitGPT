...
- Public URL is documented on `/download` and points to the **symposium-demo-v2** GitHub release asset (verify the file name matches the live release).
- **Backup**: [GitHub release page](https://github.com/Muhammad7839/FitGPT/releases/tag/symposium-demo-v2) if a browser blocks the direct file URL.
