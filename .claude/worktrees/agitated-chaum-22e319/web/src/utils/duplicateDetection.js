...
function compareItems(left, right) {
  ...
  const fields = [
    { key: "category", label: "Category", left: formatValue(left.category), right: formatValue(right.category), same: left.category === right.category },
    { key: "type", label: "Clothing Type", left: formatValue(left.clothingType), right: formatValue(right.clothingType), same: left.clothingType === right.clothingType },
    { key: "color", label: "Color", left: formatValue(left.colorTokens), right: formatValue(right.colorTokens), same: colorScore >= 0.9 },
    { key: "fit", label: "Fit", left: formatValue(left.fitTag), right: formatValue(right.fitTag), same: fitScore >= 1 },
    { key: "style", label: "Style", left: formatValue(left.styleTags), right: formatValue(right.styleTags), same: styleScore >= 0.5 },
    { key: "occasion", label: "Occasion", left: formatValue(left.occasionTags), right: formatValue(right.occasionTags), same: occasionScore >= 0.5 },
    { key: "season", label: "Season", left: formatValue(left.seasonTags), right: formatValue(right.seasonTags), same: seasonScore >= 0.5 },
  ];
